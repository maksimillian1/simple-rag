# 7: AWS Bedrock (Llama 3 8B Instruct) Selection for Context Generation
...
## Decision
We explicitly adopt **AWS Bedrock running Meta Llama 3 (8B Instruct)** as the primary generative engine.
