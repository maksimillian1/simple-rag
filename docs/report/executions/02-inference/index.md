...
Cost: `M9` gross $0.1686<!--FM33--> (8 distinct `apps-serving` nodes across the window, the same heavy churn
the error-rate investigation flagged), `D16` $0.00141<!--FD79-->/1k queries gross. That is 2.3× `r050`'s
serving cost for ~4× as many queries, so the gross figure per query fell to 56% of `r050`'s
($0.00250<!--FD78-->) rather than to a quarter of it. Node churn overhead is the likely reason, rather than
...
Cost: `M9` gross $0.4992<!--FM39-->, `D16` $0.00088<!--FD82-->/1k queries gross, the lowest of the five points: the
...
$0.18754<!--FD58-->/h ᴰ (CUR 2026-09-05 hour 12), netted once in the cross-check below (D2; `figures.yaml`
...
here; `report.md` §4.2 has them. Gross `D16` falls from $0.00250<!--FD78--> at r050 to $0.00088<!--FD82--> at r1000,
...
resting hour of its own to subtract. The gross total above is what CUR billed; the marginal is
what an additional query cost once the tier was already standing.

That is **1.5<!--FD90-->–4.3<!--FD91-->× every individual point's gross `D16`**
($0.00088<!--FD82-->–$0.00250<!--FD78-->; Matrix note). Neither `karpenter-cost-estimate.py` nor
any single point's window captured two things. One is NAT, the blind spot `01-ingestion` found
