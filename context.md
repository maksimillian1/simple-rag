...
* **Cognitive Load Reduction:** No obvious comments in the code (like `// initialize router`). The code must be self-documenting. Comment only on complex math/algorithms (e.g., the RRF formula).
