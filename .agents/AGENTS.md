...
* **Propose Before Execution:** Do not assume critical architectural parts or execute irreversible changes blindly. Always suggest a high-level approach first for user confirmation, even for operational or directory structure tasks, to ensure alignment before running file-modifying tools.
